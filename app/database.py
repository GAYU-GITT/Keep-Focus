...
def create_table(): #fields that model class has
...
#each argument we use syntax with colon, second argument as dictionary, we have put all fields with same nae
#along with colon and specifying value
